      ...
      <section id="contact">
        ...
        <footer className="bg-gray-900 text-white py-16 sm:py-20 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 sm:mb-6 tracking-tight">Let's Build Something<span className="text-blue-500">.</span></h2>
            <p className="text-gray-400 max-w-xl mx-auto mb-8 sm:mb-10 text-base sm:text-lg px-2">I'm always open to discussing AI engineering projects, internships, or building something ambitious together.</p>
            <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-4">
              ...
              <div className="relative group">
                <label className="flex items-center gap-3 w-full px-4 sm:px-5 py-3 sm:py-4 bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl cursor-pointer hover:bg-gray-800/50 hover:border-blue-500/50 transition-all">
              ...
              <button
                ...
                className="w-full px-6 sm:px-8 py-3.5 sm:py-4 bg-blue-600 text-white font-bold tracking-wide rounded-2xl hover:bg-blue-500 shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] hover:-translate-y-1 transition-all duration-300 flex justify-center items-center gap-2 disabled:bg-gray-700 disabled:cursor-not-allowed"
              >
            ...
            <div className="flex justify-center flex-wrap gap-4 sm:gap-8 mt-10 sm:mt-16 text-sm font-medium">
              <a href={SOCIAL_LINKS.github} className="flex items-center gap-2 text-gray-400 hover:text-blue-500 hover:-translate-y-1 transition-all">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href={SOCIAL_LINKS.linkedin} className="flex items-center gap-2 text-gray-400 hover:text-blue-500 hover:-translate-y-1 transition-all">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                </svg>
                LinkedIn
              </a>
              <a href={SOCIAL_LINKS.twitter} className="flex items-center gap-2 text-gray-400 hover:text-blue-500 hover:-translate-y-1 transition-all">
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
